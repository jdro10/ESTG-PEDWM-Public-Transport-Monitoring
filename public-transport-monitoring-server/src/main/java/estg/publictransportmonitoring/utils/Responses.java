...
import estg.publictransportmonitoring.Controllers.UserController;
...
public class Responses {
    ...
    public static EntityModel<Trip> tripResponse (Trip trip){
        ...
        model.add(linkTo(methodOn(UserController.class).getById(trip.getDriverId())).withRel("Driver"));
